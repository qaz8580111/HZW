...
namespace Taizhou.PLE.BLL.WebXZSPProcess
{
    public class WebXZSPProcess
    {
        //内部成员
        #region
        //流程实例标识
        ...
        public static void XZSPFrom101Submmit(WebXZSPProcess xzspprocess,
             List<AttachmentModel> materials, Form101 form101, string state)
        {

            XZSPForm xzspForm = WebXZSPProcess.GetXZSPFormByWIID(xzspprocess.wiID);
            ...
            if (state == "1") //保存
            {
                // WebXZSPProcess.Save(xzspprocess.wiID, xzspprocess.aiID, xzspForm,
            ...
            else
            {
                ...
                WebXZSPProcess.Submit(xzspprocess.wiID, xzspprocess.aiID, xzspForm, "",
        ...
        /// <param name="state">状态</param>
        public static void XZSPFrom102Submmit(WebXZSPProcess xzspprocess, Form102 form102, string state)
        {
            XZSPForm xzspForm = WebXZSPProcess.GetXZSPFormByWIID(xzspprocess.wiID);
            ...
            else if (state == "2")//退回
            {
                ...
                string aiid = WebXZSPProcess.Rollback(xzspprocess.wiID, xzspprocess.aiID, xzspForm);
                //更新APID
        ...
        /// <param name="form101">表单</param>
        /// <param name="state">状态</param>
        public static void XZSPFrom103Submmit(WebForm103 form103)
        {
            XZSPForm xzspForm = WebXZSPProcess.GetXZSPFormByWIID(form103.WIID);
            //保存之前上传附件

            //List<Attachment> attachments = new List<Attachment>();
 

            WebXZSPProcess.Save(form103.WIID, form103.AIID, xzspForm,
               form103.UserID, form103.APID);
        ...
        /// <param name="form102">表单</param>
        /// <param name="state">状态</param>
        public static void XZSPFrom104Submmit(WebForm104 form104)
        {
            XZSPForm xzspForm = WebXZSPProcess.GetXZSPFormByWIID(form104.WIID);

            WebXZSPProcess.Save(form104.WIID, form104.AIID, xzspForm,
                form104.UserID, form104.APID);
        ...
        /// <param name="form101">表单</param>
        /// <param name="state">状态</param>
        public static void XZSPFrom105Submmit(WebXZSPProcess xzspprocess, List<AttachmentModel> materials, Form105 form105, string state)
        {
            XZSPForm xzspForm = WebXZSPProcess.GetXZSPFormByWIID(xzspprocess.wiID);
        ...
        /// <param name="form102">表单</param>
        /// <param name="state">状态</param>
        public static void XZSPFrom106Submmit(WebXZSPProcess xzspprocess, Form106 form106, string state)
        {
            XZSPForm xzspForm = WebXZSPProcess.GetXZSPFormByWIID(xzspprocess.wiID);
        ...
        public static void XZSPFrom107Submmit(WebXZSPProcess xzspprocess, Form107 form107, string state)
        {
            XZSPForm xzspForm = WebXZSPProcess.GetXZSPFormByWIID(xzspprocess.wiID);
        ...
        public static void XZSPFrom108Submmit(WebXZSPProcess xzspprocess, Form108 form108, string state)
        {
            XZSPForm xzspForm = WebXZSPProcess.GetXZSPFormByWIID(xzspprocess.wiID);
