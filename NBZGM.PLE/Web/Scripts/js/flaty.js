$(function () {
    ...
    $("#sidebar a.dropdown-toggle").click(function () {
        ...
        e.slideToggle(400, function () { if ($(this).is(":hidden")) { t.attr("class", "arrow icon-angle-right"); $("#sidebar.sidebar-fixed .nav").getNiceScroll().resize() } else { t.attr("class", "arrow icon-angle-down"); n() } t.removeClass("anim-turn90").removeClass("anim-turn-90") })
    });
    $("#sidebar.sidebar-collapsed #sidebar-collapse > i").attr("class",
        "icon-double-angle-right");
    $("#sidebar-collapse").click(function () {
        $("#sidebar").toggleClass("sidebar-collapsed"); if ($("#sidebar").hasClass("sidebar-collapsed")) { $("#sidebar-collapse > i").attr("class", "icon-double-angle-right"); $.cookie("sidebar-collapsed", "true") } else { $("#sidebar-collapse > i").attr("class", "icon-double-angle-left"); $.cookie("sidebar-collapsed", "false") } $(".nice-scroll").getNiceScroll().resize(); n()
    });
    ...
    } if ($("#navbar").hasClass("navbar-fixed")) { $('#theme-setting > ul > li > a[data-target="navbar"] > i').attr("class", "icon-check green") } $("#theme-setting > ul > li > a").click(function () { var e = $(this).data("target"); var t = $(this).children("i"); if (t.hasClass("icon-check-empty")) { t.attr("class", "icon-check green"); $("#" + e).addClass(e + "-fixed"); $.cookie(e + "-fixed", "true") } else { t.attr("class", "icon-check-empty"); $("#" + e).removeClass(e + "-fixed"); $.cookie(e + "-fixed", "false") } if (e == "sidebar") { n() } });
    ...
    $(".box .box-tool > a").click(function (e) {
        ...
        switch (t) {
            case "collapse":
                ...
                break;
            case "close": $(this).parents(".box").fadeOut(500, function () { $(this).parent().remove() }); break; case "config": $("#" + $(this).data("modal")).modal("show"); break
        } e.preventDefault()
    ...
    if (jQuery().bootstrapWizard) {
        $("#form-wizard-1").bootstrapWizard({
            ...
            onPrevious: function (e, t, n) { var r = t.find("li").length; var i = n + 1; $(".step-title", $("#form-wizard-1")).text("Step " + (n + 1) + " of " + r); jQuery("li", $("#form-wizard-1")).removeClass("done"); var s = t.find("li"); for (var o = 0; o < n; o++) { jQuery(s[o]).addClass("done") } if (i == 1) { $("#form-wizard-1").find(".button-previous").hide() } else { $("#form-wizard-1").find(".button-previous").show() } if (i >= r) { $("#form-wizard-1").find(".button-next").hide(); $("#form-wizard-1").find(".button-submit").show() } else { $("#form-wizard-1").find(".button-next").show(); $("#form-wizard-1").find(".button-submit").hide() } $("html, body").animate({ scrollTop: $("#form-wizard-1").offset().top }, 900) }, onTabShow: function (e, t, n) { var r = t.find("li").length; var i = n + 1; var s = i / r * 100; $("#form-wizard-1").find(".bar").css({ width: s + "%" }) }
        }); $("#form-wizard-1").find(".button-previous").hide(); $("#form-wizard-1 .button-submit").click(function () { alert("Finished!") }).hide(); $("#form-wizard-2").bootstrapWizard({ nextSelector: ".button-next", previousSelector: ".button-previous", onTabClick: function (e, t, n) { alert("on tab click disabled"); return false }, onNext: function (e, t, n) { var r = t.find("li").length; var i = n + 1; $(".step-title", $("#form-wizard-2")).text("Step " + (n + 1) + " of " + r); jQuery("li", $("#form-wizard-2")).removeClass("done"); var s = t.find("li"); for (var o = 0; o < n; o++) { jQuery(s[o]).addClass("done") } if (i == 1) { $("#form-wizard-2").find(".button-previous").hide() } else { $("#form-wizard-2").find(".button-previous").show() } if (i >= r) { $("#form-wizard-2").find(".button-next").hide(); $("#form-wizard-2").find(".button-submit").show() } else { $("#form-wizard-2").find(".button-next").show(); $("#form-wizard-2").find(".button-submit").hide() } $("html, body").animate({ scrollTop: $("#form-wizard-2").offset().top }, 900) }, onPrevious: function (e, t, n) { var r = t.find("li").length; var i = n + 1; $(".step-title", $("#form-wizard-2")).text("Step " + (n + 1) + " of " + r); jQuery("li", $("#form-wizard-2")).removeClass("done"); var s = t.find("li"); for (var o = 0; o < n; o++) { jQuery(s[o]).addClass("done") } if (i == 1) { $("#form-wizard-2").find(".button-previous").hide() } else { $("#form-wizard-2").find(".button-previous").show() } if (i >= r) { $("#form-wizard-2").find(".button-next").hide(); $("#form-wizard-2").find(".button-submit").show() } else { $("#form-wizard-2").find(".button-next").show(); $("#form-wizard-2").find(".button-submit").hide() } $("html, body").animate({ scrollTop: $("#form-wizard-2").offset().top }, 900) }, onTabShow: function (e, t, n) { var r = t.find("li").length; var i = n + 1; var s = i / r * 100; $("#form-wizard-2").find(".bar").css({ width: s + "%" }) } }); $("#form-wizard-2").find(".button-previous").hide(); $("#form-wizard-2 .button-submit").click(function () { alert("Finished!") }).hide()
    }
    ...
    if (jQuery().plot) {
        ...
        function c() {
            ...
            while (f.length < l) {
                ...
                if (t < 0) t = 0;
                if (t > 100) t = 100; f.push(t)
            }
            var n = [];
            for (var r = 0; r < f.length; ++r)
                n.push([r, f[r]]); return n
        }
        function h() {
            if ($("#chart_1").size() == 0) {
                return
        ...
        function d() {
            ...
            plot = $.plot($("#chart_3"), [{ data: e, label: "http://themes.shamsoft.net/flaty/js/sin(x) = -0.00" }, { data: t, label: "http://themes.shamsoft.net/flaty/js/cos(x) = -0.00" }], { series: { lines: { show: true } }, crosshair: { mode: "x" }, grid: { hoverable: true, autoHighlight: false }, colors: ["#FCB322", "#A5D16C", "#52e136"], yaxis: { min: -1.2, max: 1.2 } }); var r = $("#chart_3 .legendLabel"); r.each(function () { $(this).css("width", $(this).width()) }); var i = null; var s = null; $("#chart_3").bind("plothover", function (e, t, n) { s = t; if (!i) i = setTimeout(o, 50) })
        }
        function v() {
            function r() {
                n.setData([c()]); n.draw(); setTimeout(r, t)
            }
            if ($("#chart_4").size() == 0) {
                return
            }
            var e = { series: { shadowSize: 1 }, lines: { show: true, lineWidth: .5, fill: true, fillColor: { colors: [{ opacity: .1 }, { opacity: 1 }] } }, yaxis: { min: 0, max: 100, tickFormatter: function (e) { return e + "%" } }, xaxis: { show: false }, colors: ["#6ef146"], grid: { tickColor: "#a8a3a3", borderWidth: 0 } }; var t = 30; var n = $.plot($("#chart_4"), [c()], e); r()
        }
        function m() {
            function a() {
                $.plot($("#chart_5"), [e, n, r], { series: { stack: i, lines: { show: o, fill: true, steps: u }, bars: { show: s, barWidth: .6 } } })
            }
            if ($("#chart_5").size() == 0) { return } var e = []; for (var t = 0; t <= 10; t += 1) e.push([t, parseInt(Math.random() * 30)]); var n = []; for (var t = 0; t <= 10; t += 1) n.push([t, parseInt(Math.random() * 30)]); var r = []; for (var t = 0; t <= 10; t += 1) r.push([t, parseInt(Math.random() * 30)]); var i = 0, s = true, o = false, u = false; $(".stackControls input").click(function (e) { e.preventDefault(); i = $(this).val() == "With stacking" ? true : null; a() }); $(".graphControls input").click(function (e) { e.preventDefault(); s = $(this).val().indexOf("Bars") != -1; o = $(this).val().indexOf("Lines") != -1; u = $(this).val().indexOf("steps") != -1; a() }); a()
        }
        function g() {
            function r(e, t, n) {
                if (!n) return;
    ...
    if (jQuery().fullCalendar) {
        ...
        var S = {};
        if ($(window).width() <= 320) {
            S = { left: "title, prev,next", center: "", right: "today,month,agendaWeek,agendaDay" }
        }
        else {
            S = { left: "title", center: "", right: "prev,next,today,month,agendaWeek,agendaDay" }
        }
        var x = function (e) {
            var t = { title: $.trim(e.text()) }; e.data("eventObject", t); e.draggable({ zIndex: 999, revert: true, revertDuration: 0 })
        };
        var T = function (e, t) {
            e = e.length == 0 ? "Untitled Event" : e; t = t.length == 0 ? "default" : t; var n = $('<div data-class="label label-' + t + '" class="external-event label label-' + t + '">' + e + "</div>"); jQuery("#event_box").append(n); x(n)
        };
        $("#external-events div.external-event").each(function () {
            x($(this))
        });
        $("#event_add").click(function () {
            var e = $("#event_title").val(); var t = $("#event_priority").val(); T(e, t)
        });
        var N = function () {
            $("#event_priority_chzn .chzn-search").hide(); $("#event_priority_chzn_o_1").html('<span class="label label-default">' + $("#event_priority_chzn_o_1").text() + "</span>"); $("#event_priority_chzn_o_2").html('<span class="label label-success">' + $("#event_priority_chzn_o_2").text() + "</span>"); $("#event_priority_chzn_o_3").html('<span class="label label-info">' + $("#event_priority_chzn_o_3").text() + "</span>"); $("#event_priority_chzn_o_4").html('<span class="label label-warning">' + $("#event_priority_chzn_o_4").text() + "</span>"); $("#event_priority_chzn_o_5").html('<span class="label label-important">' + $("#event_priority_chzn_o_5").text() + "</span>")
        };
        ...
        $("#calendar").fullCalendar({
            header: S, editable: true, droppable: true, drop: function (e, t) { var n = $(this).data("eventObject"); var r = $.extend({}, n); r.start = e; r.allDay = t; r.className = $(this).attr("data-class"); $("#calendar").fullCalendar("renderEvent", r, true); if ($("#drop-remove").is(":checked")) { $(this).remove() } }, events: [{ title: "All Day Event", start: new Date(E, w, 1), className: "label label-default" }, { title: "Long Event", start: new Date(E, w, b - 5), end: new Date(E, w, b - 2), className: "label label-success" }, { id: 999, title: "Repeating Event", start: new Date(E, w, b - 3, 16, 0), allDay: false, className: "label label-default" }, { id: 999, title: "Repeating Event", start: new Date(E, w, b + 4, 16, 0), allDay: false, className: "label label-important" }, { title: "Meeting", start: new Date(E, w, b, 10, 30), allDay: false, className: "label label-info" }, { title: "Lunch", start: new Date(E, w, b, 12, 0), end: new Date(E, w, b, 14, 0), allDay: false, className: "label label-warning" }, { title: "Birthday Party", start: new Date(E, w, b + 1, 19, 0), end: new Date(E, w, b + 1, 22, 30), allDay: false, className: "label label-success" }, { title: "Click for Google", start: new Date(E, w, 28), end: new Date(E, w, 29), url: "http://google.com/", className: "label label-warning" }]
        });
