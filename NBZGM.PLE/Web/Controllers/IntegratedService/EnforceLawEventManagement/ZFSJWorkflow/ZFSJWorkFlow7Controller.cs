...
{
    public class ZFSJWorkflow7Controller : Controller
    {
        //
        // GET: /ZFSJWorkflow7/
        ...
        public ActionResult Index(string WIID, string AIID, string ADID, ZFSJForm zfsjForm)
        {
            ...
            {
                ViewBag.BCCCFSID = zfsjForm.FinalForm.Form107.CCFSID;
            }
            //获取事件来源
            ...
            return View(THIS_VIEW_PATH + "ZFSJWorkflow7.cshtml", zfsjForm.FinalForm.Form107);
        }

        public ActionResult Commit(Form107 form7)
        {
            ...
            ZFSJProcess.ZFSJFrom107Submmit(wiID, aiID, adID, attachments, form7, this.Request.Form["bc"], this.Request.Form["CheckIDChange"]);
            ...
            if (this.Request.Form["bc"] != "1" && this.Request.Form["bc"] != "2" && this.Request.Form["CheckIDChange"] != "0")
            {
                ...
                {
                    //短信内容
                    string megContent = this.Request.Form["CheckIDChange"] == "1" ? UserBLL.GetUserNameByUserID(form7.ZFFJZ) : UserBLL.GetUserNameByUserID(form7.ZFJZ) + ",您在执法事件中有一条新任务等待处理";
                    ...
                    casephonesms.SENDEEID = this.Request.Form["CheckIDChange"] == "1" ? form7.ZFFJZ : form7.ZFJZ;
