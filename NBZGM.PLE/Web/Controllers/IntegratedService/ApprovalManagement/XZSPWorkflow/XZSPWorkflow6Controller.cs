...
{
    public class XZSPWorkflow6Controller : Controller
    {
        //承办机构审核申请
        // GET: /XZSPWorkflow6/
        ...
        public ActionResult Index(string WIID, string AIID, string ADID, string APID, string WDID, XZSPForm xzspForm)
        {
            ...
            ViewBag.Users = UserBLL.GetUsersByUnitID(decimal.Parse(strDDID))
                .Where(t => t.USERPOSITIONID == (decimal)UserPositionEnum.FDDZ)
                .ToList()
                .Select(c => new SelectListItem()
                {
                    Text = c.USERNAME,
                    Value = c.USERID.ToString(),
                    Selected = c.USERID == 91 ? true : false
                }).ToList();
            ...
            return View(THIS_VIEW_PATH + "XZSPWorkflow6.cshtml", xzspForm.FinalForm.Form106);
        }
        ...
        public ActionResult Commit(Form106 form106)
        {
            ...
            XZSPProcess.XZSPFrom106Submmit(xzspprocess, form106, state);
