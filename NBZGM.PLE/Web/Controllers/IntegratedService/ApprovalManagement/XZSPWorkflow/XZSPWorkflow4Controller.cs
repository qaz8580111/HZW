...
{
    public class XZSPWorkflow4Controller : Controller
    {
        //执法中队审核核查
        // GET: /XZSPWorkflow4/
        ...
        public ActionResult Index(string WIID, string AIID, string ADID, string APID, string WDID, XZSPForm xzspForm)
        {
            ...
            return View(THIS_VIEW_PATH + "XZSPWorkflow4.cshtml", xzspForm.FinalForm.Form104);
        }
        ...
        public ActionResult Commit(Form104 form104)
        {
            ...
            XZSPProcess.XZSPFrom104Submmit(xzspprocess, form104, state);
