...
{
    public class XZSPWorkflow8Controller : Controller
    {
        // 执法大队审核申请
        // GET: /XZSPWorkflow7/
        ...
        public ActionResult Index(string WIID, string AIID, string ADID, string APID, string WDID, XZSPForm xzspForm)
        {
            ...
            ViewBag.Form107 = xzspForm.FinalForm.Form107;

            return View(THIS_VIEW_PATH + "XZSPWorkflow8.cshtml", xzspForm.FinalForm.Form108);
        }

        public ActionResult Commit(Form108 form108)
        {
            ...
            XZSPProcess.XZSPFrom108Submmit(xzspprocess, form108, state);
