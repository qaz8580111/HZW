...
{
    public class YSFWWorkflow5Controller : Controller
    {
        //局领导审核环节
        // GET: /XZSPWorkflow5/
        ...
        public ActionResult Index(string WIID, string AIID, string ADID, YSFWForm ysfwForm)
        {
            ...
            return View(THIS_VIEW_PATH + "YSFWWorkflow5.cshtml");
        }
        ...
        public ActionResult Commit(Form105 form105)
        {
            ...
            form105.ID = aiID;
            form105.ADID = decimal.Parse(adID);
            XZSPACTIST instance = ActivityInstanceBLL.Single(aiID);
            form105.ADName = instance.XZSPACTDEF.ADNAME;
            ...
            baseForm.ADName = form105.ADName;
            baseForm.ProcessUserID = form105.ProcessUserID;
            baseForm.ProcessUserName = form105.ProcessUserName;
            baseForm.ProcessTime = form105.ProcessTime;
            totalForm.Form105 = form105;
            ...
            YSFWForm ysfwForm = new YSFWForm()
            {
                ...
                FinalForm = totalForm,
                CreatedTime = form105.ProcessTime.Value
            };
