...
{
    public class Workflow124Controller : Controller
    {
        public const string THIS_VIEW_PATH = @"~/Views/IntegratedService/CaseManagement/Workflow/Workflow124/";
        ...
        public ActionResult Commit(ViewModel24 viewModel24)
        {
            CaseWorkflow caseWorkflow = new CaseWorkflow(viewModel24.WIID);
            Activity activity = caseWorkflow.Workflow.Activities[viewModel24.AIID];
            ...
            form24.ProcessUser = SessionManager.User;
            form24.ProcessTime = DateTime.Now;

            form24.BADWYJ = viewModel24.BADWYJ;
            ...
            xzcfajjabg.BADWYJ = viewModel24.BADWYJ;
