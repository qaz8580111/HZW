...
{
    public class Workflow111Controller : Controller
    {
        /// <summary>
        /// 集体讨论
        /// </summary>

        public const string THIS_VIEW_PATH = @"~/Views/IntegratedService/CaseManagement/Workflow/Workflow111/";
        ...
        public ActionResult Index(string AIID, CaseForm CaseForm)
        {
            ...
            ViewModel11 viewModel11 = new ViewModel11
            {
                AIID = AIID,
                WIID = CaseForm.WIID
            };

            return PartialView(THIS_VIEW_PATH + "index.cshtml", viewModel11);
        }

        public ActionResult Commit(ViewModel11 viewModel11)
        {
            CaseWorkflow caseWorkflow = new CaseWorkflow(viewModel11.WIID);
            Activity activity = caseWorkflow.Workflow.Activities[viewModel11.AIID];
            CaseForm caseForm = caseWorkflow.CaseForm;

            caseForm.FinalForm.Form111.ID = activity.AIID;
            caseForm.FinalForm.Form111.TLJG = viewModel11.TLJG;
            caseForm.FinalForm.Form111.ProcessTime = DateTime.Now;
            caseForm.FinalForm.Form111.ProcessUser = SessionManager.User;
