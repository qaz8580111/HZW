...
{
    public class Workflow123Controller : Controller
    {
        public const string THIS_VIEW_PATH = @"~/Views/IntegratedService/CaseManagement/Workflow/Workflow123/";
        ...
        public ActionResult Commit(ViewModel23 viewModel23)
        {
            CaseWorkflow caseWorkflow = new CaseWorkflow(viewModel23.WIID);
            Activity activity = caseWorkflow.Workflow.Activities[viewModel23.AIID];
            ...
            form23.ProcessUser = SessionManager.User;
            form23.ProcessTime = DateTime.Now;

            form23.XBDYYJ = viewModel23.XBDYYJ;
            ...
            xzcfajjabg.XBDYYJ = viewModel23.XBDYYJ;
