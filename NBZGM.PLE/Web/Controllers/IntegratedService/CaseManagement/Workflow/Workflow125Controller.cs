...
{
    public class Workflow125Controller : Controller
    {
        public const string THIS_VIEW_PATH = @"~/Views/IntegratedService/CaseManagement/Workflow/Workflow125/";
        ...
        public ActionResult Commit(ViewModel25 viewModel25)
        {
            CaseWorkflow caseWorkflow = new CaseWorkflow(viewModel25.WIID);
            Activity activity = caseWorkflow.Workflow.Activities[viewModel25.AIID];
            ...
            form25.ProcessUser = SessionManager.User;
            form25.ProcessTime = DateTime.Now;
            form25.FZCYJ = viewModel25.FZCYJ;
            ...
            xzcfajjabg.FZCYJ = viewModel25.FZCYJ;
