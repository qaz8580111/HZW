...
namespace Web.Process.GGFWProcess
{
    public class GGFWProcess
    {
        /// <summary>
        /// 上传附件
        /// </summary>
        ...
        {
            //创建一个工作流实例
            ZFSJWORKFLOWINSTANCE wfist = ZFSJProcess.ZFSJProcess.Create(SessionManager.User.UserID.ToString(), eventReport.SSZDID);
