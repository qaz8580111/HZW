...
namespace HZW.ZHCG.BLL
{
    public class CameraBLL
    {
        ...
        {
            return cameraDAL.getcameraListPageIndex(pagesize, filtrateName);
        }
        ...
        {
            List<fi_camera_info> list = cameraDAL.getcameraList(pagesize, pageindex).ToList();
            return list;
        }
        ...
        {
            List<fi_camera_info> list = cameraDAL.getcameraList(pagesize, pageindex, filtrateName).ToList();
            return list;
        }
        ...
        {
           return cameraDAL.getdetails(id);
        }
        ...
        {
            return cameraDAL.getListTree(name);
        }
        ...
        {
            return cameraDAL.getaregionlist();
        }
        ...
        {
            return cameraDAL.getNumberByRegion();
        }
        ...
        {
            return cameraDAL.getCameraGridData();
        }
        ...
        {
            return cameraDAL.getCameraTypeNumber();
        }
        ...
        {
            return cameraDAL.getCameraTypeCount();
        }
        ...
        {
            return cameraDAL.getwrj(filter, pageIndex, pageSize);
        }
        ...
        {
            return cameraDAL.getwrj(filter, pageSize);
        }
        ...
        {
            return cameraDAL.getcamera(cameraid);
        }
        ...
        {
            return cameraDAL.getcamera(lon,lat,r);
        }
    }
}
