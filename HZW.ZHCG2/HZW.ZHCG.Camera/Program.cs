        ...
        public static void Main(string[] args)
        {
            ...
            for (; ; )
            {
                ...
                foreach (var item in cidtos)
                {
                    ...
                    {
                        playback = playback.Replace("<Imp ip=\"192.168.20.11\" port=\"80\" />", "<Imp ip=\"192.168.20.11\" port=\"80\" userName=\"admin\" password=\"b213ceac2f1022023ef2699aa62599cf\"/>");
                    ...
                    //{
                    //    WGS84ToCGCS2000(item.longitude.Value, item.latitude.Value, out x, out y);
                    //}
