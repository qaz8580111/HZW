function initPager(obj,pageCount) {
    var html = "<img class='btn_img' src='../Image/firstPage.png' onclick='firstPage()' title='首页' /><img class='btn_img' src='../Image/lastPage.png' onclick='lastPage()' title='上一页' /><span class='showpagedelite'>第<span id='currentPage'>1</span>/<span id='pageCount'></span>页</span><img class='btn_img' src='../Image/nextPage.png' onclick='nextPage()' title='下一页' /><img class='btn_img' src='../Image/Shadowe.png' onclick='shadowe()' title='尾页' /><input type='number' id='pagenumber' class='text' min='1' value='1' required='required'  /><input type='button' value='Go' class='Go' onclick='jump()' /><input type='hidden' id='thisPageIndex' value='1' />";
    obj.html(html);
