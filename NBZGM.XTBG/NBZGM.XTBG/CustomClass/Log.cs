    ...
    public static class Log
    {
        ...
        public static void WriteLog(string strFileName, string strFileContent, Exception ex)
        {
            ...
            if (ex != null)
            {
                ...
                for (int i = 0; i < 100 && InnerEx != null; i++)
                {
                    sb.AppendLine("InnerMessage:" + InnerEx.Message);
                    sb.AppendLine("InnerSource:" + InnerEx.Source);
                ...
                //        {
                //            sb.AppendLine("InnerException.InnerException.InnerException.Message:" + ex.InnerException.InnerException.InnerException.Message);
                //            sb.AppendLine("InnerException.InnerException.InnerException.Source: " + ex.InnerException.InnerException.InnerException.Source);
                //        }
                //    }
                //}
            }
